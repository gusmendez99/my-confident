$(document).ready(function () {
	...
	$("#receiver").autocomplete({
		source: $SCRIPT_ROOT + "/user/find-all",
	});
	...
	$("#new_chat").click(function () {
		...
		$.getJSON(
			...
			function (data) {
				...
				$.post($SCRIPT_ROOT + "/chat/create", req_data, function (
					data
				) {
					if (data.error) {
						alert(data.error);
